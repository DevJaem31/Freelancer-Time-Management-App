		...
		>
			<div className='card-header flex flex-row justify-between mb-3 pb-1 border-b-1 border-b-blue-950'>
				<div className='flex flex-col items-start'>
					<h2 className='font-semibold text-lg md:text-xl tracking-wider'>{title}</h2>
			...
			<div className='items-end justify-self-end status-container rounded-2xl text-xs md:text-sm border w-fit px-3 py-1 md:py-0 mt-2'>
				{status}
			</div>
		</div>
	);
